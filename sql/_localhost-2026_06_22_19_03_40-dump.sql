...
INSERT INTO `evaluate_item` VALUES (2068894120349405186,2068894120282296321,'5',0,1,1,1,'admin','2026-06-22 11:09:31','admin','2026-06-22 16:14:38'),(2068962298656190466,2068894120282296321,'123',1,1,1,0,'admin','2026-06-22 15:40:26','admin','2026-06-22 15:40:26');
...
INSERT INTO `evaluate_order` VALUES (2067229909639532546,'关于xxxxx的评议事项','张三','安调中心','2026-06-19',1,'111',0,'admin','2026-06-17 20:56:32','admin','2026-06-17 20:56:32'),(2067242144499884034,'关于张三XXXXX事项的调查问卷','张三','安调中心','2026-06-25',1,'测试',0,'admin','2026-06-17 21:45:09','admin','2026-06-17 21:45:09'),(2068870284191150081,'111','222','333','2026-06-23',0,'444',1,'admin','2026-06-22 09:34:48','admin','2026-06-22 09:49:59'),(2068870824853712897,'111','222','333','2026-06-09',0,'444',1,'admin','2026-06-22 09:36:57','admin','2026-06-22 09:50:01'),(2068894120282296321,'1','2','3','2026-06-12',1,'4',0,'admin','2026-06-22 11:09:31','admin','2026-06-22 11:09:31');
...
CREATE TABLE `evaluate_receipt` (
  ...
  `order_id` bigint NOT NULL COMMENT '评议单id',
  `receipt_code` varchar(50) DEFAULT NULL COMMENT '回执单code',
  `deleted` tinyint NOT NULL DEFAULT '0',
  `create_bt` varchar(50) NOT NULL,
  `create_time` datetime NOT NULL,
  `update_by` varchar(50) NOT NULL,
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`receipt_id`),
  KEY `order_id_index` (`order_id`),
  KEY `receipt_code_index` (`receipt_code`)
...
CREATE TABLE `evaluate_record` (
  ...
  `content` varchar(255) DEFAULT NULL COMMENT '评议内容，可能是分数，可能是文本',
  `deleted` tinyint NOT NULL DEFAULT '0',
  `create_by` varchar(50) NOT NULL,
  `create_time` datetime NOT NULL,
  `update_by` varchar(50) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评议记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `evaluate_record`
--

LOCK TABLES `evaluate_record` WRITE;
/*!40000 ALTER TABLE `evaluate_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `evaluate_record` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_logininfor` VALUES (100,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码已失效','2025-07-19 12:25:32'),(101,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-07-19 12:25:36'),(102,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-17 20:50:06'),(103,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-18 08:34:21'),(104,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-18 17:18:25'),(105,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-22 08:27:37'),(106,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-22 10:48:47'),(107,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-22 14:16:01'),(108,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-22 14:58:00'),(109,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-22 17:44:59'),(110,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-22 18:00:58');
...
-- Dump completed on 2026-06-22 19:03:41

...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_dict_type` VALUES (1,'用户性别','sys_user_sex','0','admin','2025-07-19 12:25:23','',NULL,'用户性别列表'),(2,'菜单状态','sys_show_hide','0','admin','2025-07-19 12:25:23','',NULL,'菜单状态列表'),(3,'系统开关','sys_normal_disable','0','admin','2025-07-19 12:25:23','',NULL,'系统开关列表'),(4,'任务状态','sys_job_status','0','admin','2025-07-19 12:25:23','',NULL,'任务状态列表'),(5,'任务分组','sys_job_group','0','admin','2025-07-19 12:25:23','',NULL,'任务分组列表'),(6,'系统是否','sys_yes_no','0','admin','2025-07-19 12:25:23','',NULL,'系统是否列表'),(7,'通知类型','sys_notice_type','0','admin','2025-07-19 12:25:23','',NULL,'通知类型列表'),(8,'通知状态','sys_notice_status','0','admin','2025-07-19 12:25:23','',NULL,'通知状态列表'),(9,'操作类型','sys_oper_type','0','admin','2025-07-19 12:25:23','',NULL,'操作类型列表'),(10,'系统状态','sys_common_status','0','admin','2025-07-19 12:25:23','',NULL,'登录状态列表'),(100,'评议单状态','evaluate_order_status','0','admin','2026-06-17 20:57:12','',NULL,NULL);
...
INSERT INTO `sys_logininfor` VALUES (100,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码已失效','2025-07-19 12:25:32'),(101,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-07-19 12:25:36'),(102,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-17 20:50:06');
...
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-17 21:50:13

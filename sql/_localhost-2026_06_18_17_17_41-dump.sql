...
INSERT INTO `evaluate_order` VALUES (2067229909639532546,'关于xxxxx的评议事项','张三','安调中心','2026-06-19',0,'111',0,'admin','2026-06-17 20:56:32','admin','2026-06-17 20:56:32'),(2067242144499884034,'关于张三XXXXX事项的调查问卷','张三','安调中心','2026-06-25',1,'测试',0,'admin','2026-06-17 21:45:09','admin','2026-06-17 21:45:09');
...
--
-- Table structure for table `evaluateitem_option`
--

DROP TABLE IF EXISTS `evaluateitem_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evaluateitem_option` (
...
--
-- Dumping data for table `evaluateitem_option`
--

LOCK TABLES `evaluateitem_option` WRITE;
/*!40000 ALTER TABLE `evaluateitem_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `evaluateitem_option` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_logininfor` VALUES (100,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码已失效','2025-07-19 12:25:32'),(101,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-07-19 12:25:36'),(102,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-17 20:50:06'),(103,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-06-18 08:34:21');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=166 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-18 17:17:41
